...
Keyboard shortcuts: **←** previous, **→** next, **F10** step over, **Shift+F11** step
out, **F11** next call, **Home** and **End** for the first and last snapshot, and
**Escape** to close. Keystrokes typed into an input field are ignored.
