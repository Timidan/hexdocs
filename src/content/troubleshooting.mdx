...
description: Diagnose failed quotes, stalled orders, rejected approvals, and proxy errors.
---

Work down from the symptom you can see. Most failures in the Earn module fall into
one of four groups: the quote, the approval, the order, or the proxy.
...
|---|---|---|
| `403 Forbidden` | `PROXY_SECRET` is set | Unset it. The browser client cannot send `x-proxy-secret` — see [Configuration](/configuration) |
